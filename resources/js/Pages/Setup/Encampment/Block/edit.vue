...
const form = useForm(propsData.block);
const blocks = ref(propsData.blocks);

const submit = () => {
  form.put(route("setup.block.update", propsData.block), {
    onSuccess: () => toast.success("Camp update Successfully"),
  });
};
