...
<template>
  <BreezeDataTableFilter
    ...
    placeholder="Agency Name || Team Name || Contact Person || Email || Mobile"
  >
    <div v-if="agencies.length > 0" class="col-md-4">
      <BreezeLabel for="agency" value="Agency" />
      <multi-select
        :searchable="true"
